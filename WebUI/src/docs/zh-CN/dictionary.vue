...
<div class="buttons">
  ...
  <el-button @click="addChildNode">添加所选分类</el-button>
    ...
    methods: {
      ...
      nodeclick(item,el,store){
          ...
          if(store.$parent.node){
            ...
            this.$http.post("dictionary/GetItemByParentId",{pageIndex:0,pageSize:20,keyword:item.id}).then(function(r){
              this.tableData=r.body;
            },repError)
          }else{
            this.tableData=[];
          }
